  ...
  try {
    ...
    await Promise.all([
      resend.emails.send({
        ...
        replyTo: email,
        subject: `👤 New Event Attendee: ${safe.fullName}`,
        text: `General Attendee Registration - Workbook Launch\n\nName: ${fullName}\nEmail: ${email}\nPhone: ${phone}\nOccupation: ${body.occupation || 'Not specified'}\nOrganization: ${body.organization || 'Not specified'}\nHeard About: ${body.heardAbout || 'Not specified'}\nInterest: ${body.interest || 'Not specified'}\nMessage: ${body.message || 'None provided'}`,
        html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #9333ea, #7e22ce); padding: 24px; border-radius: 12px 12px 0 0;">
            <h2 style="color: white; margin: 0;">👤 New Event Attendee</h2>
          ...
          <div style="background-color: #f9fafb; padding: 24px; border-radius: 0 0 12px 12px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 8px 0; font-weight: bold; color: #374151;">Occupation</td><td style="padding: 8px 0; color: #4b5563;">${safe.occupation}</td></tr>
              ...
              <tr><td style="padding: 8px 0; font-weight: bold; color: #374151;">Interest</td><td style="padding: 8px 0; color: #4b5563;">${safe.interest}</td></tr>
              <tr><td style="padding: 8px 0; font-weight: bold; color: #374151;">Message</td><td style="padding: 8px 0; color: #4b5563;">${safe.message}</td></tr>
            </table>
          </div>
        </div>
      `,
